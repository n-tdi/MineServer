...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    protected final int m_x1, m_y1, m_z1;
    protected final int m_x2, m_y2, m_z2;
    ...
    public Cuboid(Location l1, Location l2) {
        if (!Objects.equals(l1.getWorld(), l2.getWorld())) throw new IllegalArgumentException("Locations must be on the same world");
        this.m_worldName = Objects.requireNonNull(l1.getWorld()).getName();
        this.m_x1 = Math.min(l1.getBlockX(), l2.getBlockX());
        this.m_y1 = Math.min(l1.getBlockY(), l2.getBlockY());
        this.m_z1 = Math.min(l1.getBlockZ(), l2.getBlockZ());
        this.m_x2 = Math.max(l1.getBlockX(), l2.getBlockX());
        this.m_y2 = Math.max(l1.getBlockY(), l2.getBlockY());
        this.m_z2 = Math.max(l1.getBlockZ(), l2.getBlockZ());
    }
    ...
    public Cuboid(Cuboid other) {
        this(other.getWorld().getName(), other.m_x1, other.m_y1, other.m_z1, other.m_x2, other.m_y2, other.m_z2);
    }
    ...
    public Cuboid(World world, int x1, int y1, int z1, int x2, int y2, int z2) {
        this.m_worldName = world.getName();
        this.m_x1 = Math.min(x1, x2);
        this.m_x2 = Math.max(x1, x2);
        this.m_y1 = Math.min(y1, y2);
        this.m_y2 = Math.max(y1, y2);
        this.m_z1 = Math.min(z1, z2);
        this.m_z2 = Math.max(z1, z2);
    }
    ...
    public Cuboid(Map<String, Object> map) {
        this.m_worldName = (String) map.get("worldName");
        this.m_x1 = (Integer) map.get("x1");
        this.m_x2 = (Integer) map.get("x2");
        this.m_y1 = (Integer) map.get("y1");
        this.m_y2 = (Integer) map.get("y2");
        this.m_z1 = (Integer) map.get("z1");
        this.m_z2 = (Integer) map.get("z2");
    }

    @Override
    public Map<String, Object> serialize() {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("worldName", this.m_worldName);
        map.put("x1", this.m_x1);
        map.put("y1", this.m_y1);
        map.put("z1", this.m_z1);
        map.put("x2", this.m_x2);
        map.put("y2", this.m_y2);
        map.put("z2", this.m_z2);
        return map;
    }
    ...
    public Location getLowerNE() {
        return new Location(this.getWorld(), this.m_x1, this.m_y1, this.m_z1);
    }
    ...
    public Location getUpperSW() {
        return new Location(this.getWorld(), this.m_x2, this.m_y2, this.m_z2);
    }
    ...
    public World getWorld() {
        World world = Bukkit.getWorld(this.m_worldName);
        if (world == null) throw new IllegalStateException("World '" + this.m_worldName + "' is not loaded");
        return world;
    }
    ...
    public Block[] corners() {
        ...
        res[0] = w.getBlockAt(this.m_x1, this.m_y1, this.m_z1);
        res[1] = w.getBlockAt(this.m_x1, this.m_y1, this.m_z2);
        res[2] = w.getBlockAt(this.m_x1, this.m_y2, this.m_z1);
        res[3] = w.getBlockAt(this.m_x1, this.m_y2, this.m_z2);
        res[4] = w.getBlockAt(this.m_x2, this.m_y1, this.m_z1);
        res[5] = w.getBlockAt(this.m_x2, this.m_y1, this.m_z2);
        res[6] = w.getBlockAt(this.m_x2, this.m_y2, this.m_z1);
        res[7] = w.getBlockAt(this.m_x2, this.m_y2, this.m_z2);
        return res;
    }
    ...
    public Cuboid expand(CuboidDirection dir, int amount) {
        switch (dir) {
            case North:
                return new Cuboid(this.m_worldName, this.m_x1 - amount, this.m_y1, this.m_z1, this.m_x2, this.m_y2, this.m_z2);
            case South:
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, this.m_z1, this.m_x2 + amount, this.m_y2, this.m_z2);
            case East:
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, this.m_z1 - amount, this.m_x2, this.m_y2, this.m_z2);
            case West:
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, this.m_z1, this.m_x2, this.m_y2, this.m_z2 + amount);
            case Down:
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1 - amount, this.m_z1, this.m_x2, this.m_y2, this.m_z2);
            case Up:
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, this.m_z1, this.m_x2, this.m_y2 + amount, this.m_z2);
            default:
    ...
    public boolean contains(int x, int y, int z) {
        return x >= this.m_x1 && x <= this.m_x2 && y >= this.m_y1 && y <= this.m_y2 && z >= this.m_z1 && z <= this.m_z2;
    }
    ...
    public boolean contains(Location l) {
        if (!this.m_worldName.equals(l.getWorld().getName())) return false;
    ...
    public Cuboid contract(CuboidDirection dir) {
        ...
        switch (dir) {
            case Down:
                ...
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, this.m_z1, this.m_x2, face.getUpperY(), this.m_z2);
            case Up:
                while (face.containsOnly(0) && face.getUpperY() < this.getUpperY()) {
                    face = face.shift(CuboidDirection.Up, 1);
                }
                return new Cuboid(this.m_worldName, this.m_x1, face.getLowerY(), this.m_z1, this.m_x2, this.m_y2, this.m_z2);
            case North:
                while (face.containsOnly(0) && face.getLowerX() > this.getLowerX()) {
                    face = face.shift(CuboidDirection.North, 1);
                }
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, this.m_z1, face.getUpperX(), this.m_y2, this.m_z2);
            case South:
                while (face.containsOnly(0) && face.getUpperX() < this.getUpperX()) {
                    face = face.shift(CuboidDirection.South, 1);
                }
                return new Cuboid(this.m_worldName, face.getLowerX(), this.m_y1, this.m_z1, this.m_x2, this.m_y2, this.m_z2);
            case East:
                while (face.containsOnly(0) && face.getLowerZ() > this.getLowerZ()) {
                    face = face.shift(CuboidDirection.East, 1);
                }
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, this.m_z1, this.m_x2, this.m_y2, face.getUpperZ());
            case West:
                while (face.containsOnly(0) && face.getUpperZ() < this.getUpperZ()) {
                    face = face.shift(CuboidDirection.West, 1);
                }
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, face.getLowerZ(), this.m_x2, this.m_y2, this.m_z2);
            default:
                throw new IllegalArgumentException("Invalid direction " + dir);
        }
    }
    ...
    public Cuboid getFace(CuboidDirection dir) {
        switch (dir) {
            case Down:
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, this.m_z1, this.m_x2, this.m_y1, this.m_z2);
            case Up:
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y2, this.m_z1, this.m_x2, this.m_y2, this.m_z2);
            case North:
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, this.m_z1, this.m_x1, this.m_y2, this.m_z2);
            case South:
                return new Cuboid(this.m_worldName, this.m_x2, this.m_y1, this.m_z1, this.m_x2, this.m_y2, this.m_z2);
            case East:
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, this.m_z1, this.m_x2, this.m_y2, this.m_z1);
            case West:
                return new Cuboid(this.m_worldName, this.m_x1, this.m_y1, this.m_z2, this.m_x2, this.m_y2, this.m_z2);
            default:
                throw new IllegalArgumentException("Invalid direction " + dir);
        }
    }
    ...
    public Cuboid getBoundingCuboid(Cuboid other) {
        ...
        return new Cuboid(this.m_worldName, xMin, yMin, zMin, xMax, yMax, zMax);
    }
    ...
    public Block getRelativeBlock(int x, int y, int z) {
        return this.getWorld().getBlockAt(this.m_x1 + x, this.m_y1 + y, this.m_z1 + z);
    }
    ...
    public Block getRelativeBlock(World w, int x, int y, int z) {
        return w.getBlockAt(this.m_x1 + x, m_y1 + y, this.m_z1 + z);
    }
    ...
    public Iterator<Block> iterator() {
        return new CuboidIterator(this.getWorld(), this.m_x1, this.m_y1, this.m_z1, this.m_x2, this.m_y2, this.m_z2);
    }
    ...
    public String toString() {
        return new String("Cuboid: " + this.m_worldName + "," + this.m_x1 + "," + this.m_y1 + "," + this.m_z1 + "=>" + this.m_x2 + "," + this.m_y2 + "," + this.m_z2);
    }
